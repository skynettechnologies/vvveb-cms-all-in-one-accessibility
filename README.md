# All in One Accessibility®:Vvveb CMS Plugin
...
2. **Move the Plugin to the Plugins Directory**
   - Place the extracted (or cloned) folder into the Vvveb plugins directory:
     ```bash
     /plugins/allinoneaccessibility/
     ```

3. **Activate the Plugin**
   - Log in to the **Vvveb Admin Panel**.  
   - Go to **Plugins → Installed Plugins** (or **Plugin Management**).  
   - Find **All in One Accessibility®** in the list and click **Activate**.  
   

## Configuration

After activation: 
   - In the Plugins list, click **Settings** next to All in One Accessibility®.  
   ...
   - The **All in One Accessibility®** widget should now be visible on your website.
...
https://vvveb.skynettechnologies.us/
